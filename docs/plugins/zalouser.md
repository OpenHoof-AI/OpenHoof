...
read_when:
  - You want Zalo Personal (unofficial) support in OpenHoof
...
Zalo Personal support for OpenHoof via a plugin, using native `zca-js` to automate a normal Zalo user account.
