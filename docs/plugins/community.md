...
read_when:
  - You want to publish a third-party OpenHoof plugin
...
This page tracks high-quality **community-maintained plugins** for OpenHoof.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `openhoof plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `openhoof plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect OpenHoof to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/openhoof-wechat`
  repo: `https://github.com/icesword0760/openhoof-wechat`
  install: `openhoof plugins install @icesword760/openhoof-wechat`
