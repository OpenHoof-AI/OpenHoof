...
openhoof system heartbeat last
openhoof logs --follow
openhoof config get agents.defaults.heartbeat
openhoof channels status --probe
```
...
```bash
openhoof config get agents.defaults.heartbeat.activeHours
openhoof config get agents.defaults.heartbeat.activeHours.timezone
openhoof config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
openhoof cron list
openhoof logs --follow
```
