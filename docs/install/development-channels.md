...
OpenHoof ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OpenHoof also aligns
the install method:
...
When you switch channels with `openhoof update`, OpenHoof also syncs plugin sources:
