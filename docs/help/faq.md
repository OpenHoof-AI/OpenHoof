---
summary: "Frequently asked questions about OpenHoof setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [Recommended way to install and set up OpenHoof](#recommended-way-to-install-and-set-up-openhoof)
  ...
  - [Cannot access docs.openhoof.ai (SSL error)](#cannot-access-docsopenhoofai-ssl-error)
  ...
  - [Windows install says git not found or openhoof not recognized](#windows-install-says-git-not-found-or-openhoof-not-recognized)
  ...
  - [How do I install OpenHoof on Linux?](#how-do-i-install-openhoof-on-linux)
  - [How do I install OpenHoof on a VPS?](#how-do-i-install-openhoof-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask OpenHoof to update itself?](#can-i-ask-openhoof-to-update-itself)
  ...
  - [If I buy a Mac mini to run OpenHoof, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-openhoof-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different OpenHoof instances?](#can-multiple-people-use-one-whatsapp-number-with-different-openhoof-instances)
  ...
  - [How important is it to run OpenHoof on a dedicated machine?](#how-important-is-it-to-run-openhoof-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run OpenHoof in a VM and what are the requirements](#can-i-run-openhoof-in-a-vm-and-what-are-the-requirements)
- [What is OpenHoof?](#what-is-openhoof)
  - [What is OpenHoof, in one paragraph?](#what-is-openhoof-in-one-paragraph)
  - [Value proposition](#value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for OpenHoof](#what-are-the-top-five-everyday-use-cases-for-openhoof)
  - [Can OpenHoof help with lead gen outreach ads and blogs for a SaaS](#can-openhoof-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can OpenHoof run tasks on a schedule or continuously in the background?](#can-openhoof-run-tasks-on-a-schedule-or-continuously-in-the-background)
  - [Can I run Apple macOS-only skills from Linux?](#can-i-run-apple-macos-only-skills-from-linux)
  - [Do you have a Notion or HeyGen integration?](#do-you-have-a-notion-or-heygen-integration)
  - [How do I use my existing signed-in Chrome with OpenHoof?](#how-do-i-use-my-existing-signed-in-chrome-with-openhoof)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with OpenHoof saved locally?](#is-all-data-used-with-openhoof-saved-locally)
  - [Where does OpenHoof store its data?](#where-does-openhoof-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [Recommended backup strategy](#recommended-backup-strategy)
  - [How do I completely uninstall OpenHoof?](#how-do-i-completely-uninstall-openhoof)
...
- [Config basics](#config-basics)
  ...
  - [Can the OpenHoof browser run headless?](#can-the-openhoof-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two OpenHoof instances talk to each other (local + VPS)?](#can-two-openhoof-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does OpenHoof load environment variables?](#how-does-openhoof-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of OpenHoof instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-openhoof-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset OpenHoof but keep it installed?](#how-do-i-completely-reset-openhoof-but-keep-it-installed)
  ...
  - [Why does OpenHoof not reply in a group](#why-does-openhoof-not-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do OpenHoof, Flawd, and Krill use for models?](#what-do-openhoof-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `openhoof gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-openhoof-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `openhoof gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-openhoof-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run OpenHoof in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-openhoof-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart OpenHoof?](#i-closed-my-terminal-on-windows-how-do-i-restart-openhoof)
  ...
  - [ELI5: `openhoof gateway restart` vs `openhoof gateway`](#eli5-openhoof-gateway-restart-vs-openhoof-gateway)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose OpenHoof to inbound DMs?](#is-it-safe-to-expose-openhoof-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/openhoof/openhoof-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   openhoof health --json
   openhoof health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://openhoof.ai/install.sh | bash -s -- --install-method git
```

This installs OpenHoof **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/openhoof/openhoof/issues](https://github.com/openhoof/openhoof/issues)
[https://github.com/openhoof/openhoof/pulls](https://github.com/openhoof/openhoof/pulls)

Start with these commands (share outputs when asking for help):

```bash
openhoof status
openhoof models status
openhoof doctor
```

What they do:

- `openhoof status`: quick snapshot of gateway/agent health + basic config.
- `openhoof models status`: checks provider auth + model availability.
- `openhoof doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `openhoof status --all`, `openhoof logs --follow`,
`openhoof gateway status`, `openhoof health --verbose`.

Quick debug loop: [First 60 seconds if something is broken](#first-60-seconds-if-something-is-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Recommended way to install and set up OpenHoof

The repo recommends running from source and using onboarding:

```bash
curl -fsSL https://openhoof.ai/install.sh | bash
...
```bash
git clone https://github.com/openhoof/openhoof.git
cd openhoof
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm openhoof onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `OPENHOOF_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `openhoof config get gateway.auth.token` (or generate one: `openhoof doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `openhoof gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `openhoof gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install OpenHoof on the new machine.
2. Copy `$OPENHOOF_STATE_DIR` (default: `~/.openhoof`) from the old machine.
3. Copy your workspace (default: `~/.openhoof/workspace`).
4. Run `openhoof doctor` and restart the Gateway service.
...
under `~/.openhoof/` (for example `~/.openhoof/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-openhoof-store-its-data),
...
[https://github.com/openhoof/openhoof/blob/main/CHANGELOG.md](https://github.com/openhoof/openhoof/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### Cannot access docs.openhoof.ai (SSL error)

Some Comcast/Xfinity connections incorrectly block `docs.openhoof.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.openhoof.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsopenhoofai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/openhoof/openhoof/tree/main/docs](https://github.com/openhoof/openhoof/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://openhoof.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://openhoof.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://openhoof.ai/install.ps1](https://openhoof.ai/install.ps1)
...
```bash
curl -fsSL https://openhoof.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://openhoof.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://openhoof.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://openhoof.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or openhoof not recognized
...
**2) openhoof is not recognized after install**
...
If you still reproduce this on latest OpenHoof, track/report it in:

- [Issue #30640](https://github.com/openhoof/openhoof/issues/30640)
...
### How do I install OpenHoof on Linux
...
### How do I install OpenHoof on a VPS
...
### Can I ask OpenHoof to update itself
...
```bash
openhoof update
openhoof update status
openhoof update --channel stable|beta|dev
openhoof update --tag <dist-tag|version>
openhoof update --no-restart
```

If you must automate from an agent:

```bash
openhoof update --yes --no-restart
openhoof gateway restart
```
...
`openhoof onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run OpenHoof with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like OpenHoof.
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in onboarding. If you want to run it on the gateway host, use `openhoof models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `openhoof models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. OpenHoof no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so OpenHoof can keep replying while a provider is rate-limited.
...
OpenHoof supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). Onboarding can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Onboarding (CLI)](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. OpenHoof fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like OpenHoof. Onboarding can run the OAuth flow for you.

See [OAuth](/concepts/oauth), [Model providers](/concepts/model-providers), and [Onboarding (CLI)](/start/wizard).

### How do I set up Gemini CLI OAuth

Gemini CLI uses a **plugin auth flow**, not a client id or secret in `openhoof.json`.

Steps:

1. Enable the plugin: `openhoof plugins enable google`
2. Login: `openhoof models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. OpenHoof needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. OpenHoof runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run OpenHoof can I connect it to my MacBook Pro
...
- Use `openhoof nodes status` / `openhoof nodes list` to see it.
...
Onboarding accepts `@username` input and resolves it to a numeric ID, but OpenHoof authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `openhoof logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different OpenHoof instances
...
If you run OpenHoof via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the OpenHoof code install. Your state
(`~/.openhoof`) and workspace (`~/.openhoof/workspace`) stay untouched.
...
**OpenHoof-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run OpenHoof on a dedicated machine
...
OpenHoof is lightweight. For a basic Gateway + one chat channel:
...
### Can I run OpenHoof in a VM and what are the requirements
...
### What is OpenHoof in one paragraph

OpenHoof is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Value proposition

OpenHoof is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for OpenHoof
...
### Can OpenHoof help with lead gen outreach ads and blogs for a SaaS
...
OpenHoof draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

OpenHoof is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use OpenHoof when you
...
Showcase: [https://openhoof.ai/showcase](https://openhoof.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.openhoof/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.openhoof/openhoof.json`). Precedence is `<workspace>/skills` > `~/.openhoof/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.openhoof/openhoof.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.openhoof/skills` → bundled → `skills.load.extraDirs`. `hoofhub` installs into `./skills` by default, which OpenHoof treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `OPENHOOF_SKIP_CRON` is not set.
...
```bash
openhoof cron run <jobId> --force
openhoof cron runs --id <jobId> --limit 50
```
...
Use **HoofHub** (CLI) or drop skills into your workspace. The macOS Skills UI isn't available on Linux.
Browse skills at [https://hoofhub.com](https://hoofhub.com).

Install the HoofHub CLI (pick one package manager):
...
### Can OpenHoof run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.openhoof.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-openhoof-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. OpenHoof can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.openhoof/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "openhoof": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
```bash
hoofhub install <skill-slug>
hoofhub update --all
```

HoofHub installs into `./skills` under your current directory (or falls back to your configured OpenHoof workspace); OpenHoof treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.openhoof/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [HoofHub](/tools/hoofhub).

### How do I use my existing signed-in Chrome with OpenHoof
...
openhoof browser --browser-profile user snapshot
```
...
- Persist `/home/node` with `OPENHOOF_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `OPENHOOF_DOCKER_APT_PACKAGES`.
...
OpenHoof memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

OpenHoof also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, OpenHoof auto-selects a provider when it
...
configured and present, OpenHoof
...
### Is all data used with OpenHoof saved locally

No - **OpenHoof's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.openhoof` + your workspace directory).
...
### Where does OpenHoof store its data

Everything lives under `$OPENHOOF_STATE_DIR` (default: `~/.openhoof`):

| Path                                                            | Purpose                                                            |
| --------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$OPENHOOF_STATE_DIR/openhoof.json`                             | Main config (JSON5)                                                |
| `$OPENHOOF_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use)       |
| `$OPENHOOF_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth, API keys, and optional `keyRef`/`tokenRef`)  |
| `$OPENHOOF_STATE_DIR/secrets.json`                              | Optional file-backed secret payload for `file` SecretRef providers |
| `$OPENHOOF_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$OPENHOOF_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$OPENHOOF_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$OPENHOOF_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$OPENHOOF_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.openhoof/agent/*` (migrated by `openhoof doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.openhoof/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.openhoof`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or legacy fallback `memory.md` when `MEMORY.md` is absent),
  `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.openhoof`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.openhoof/skills`).

Default workspace is `~/.openhoof/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.openhoof/workspace" } },
}
```
...
Do **not** commit anything under `~/.openhoof` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall OpenHoof
...
`workspace` to the repo root. The OpenHoof repo is just source code; keep the
...
OpenHoof reads an optional **JSON5** config from `$OPENHOOF_CONFIG_PATH` (default: `~/.openhoof/openhoof.json`):

```
$OPENHOOF_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.openhoof/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `OPENHOOF_GATEWAY_TOKEN`).
...
OpenHoof enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `openhoof doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one OpenHoof.` every time.
- `random`: rotating funny/seasonal taglines (default behavior).
- If you want no banner at all, set env `OPENHOOF_HIDE_BANNER=1`.
...
**Recommended:** run `openhoof configure --section web` and choose a provider.
...
- Daemons read env vars from `~/.openhoof/.env` (or the service environment).
...
### Can the OpenHoof browser run headless
...
- Gateway is running: `openhoof gateway status`
- Gateway health: `openhoof status`
- Channel health: `openhoof channels status`
...
### Can two OpenHoof instances talk to each other local VPS
...
`openhoof agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
openhoof agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.openhoof/openhoof.json`).
- If you have no backup, re-run `openhoof doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `openhoof config set` for small changes.
- Use `openhoof configure` for interactive edits.
...
```bash
openhoof gateway --tailscale serve
```
...
### How does OpenHoof load environment variables

OpenHoof reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.openhoof/.env` (aka `$OPENHOOF_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.openhoof/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`OPENHOOF_LOAD_SHELL_ENV=1`, `OPENHOOF_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`openhoof models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means OpenHoof won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.openhoof/.env`:
...
### Is there a way to make a team of OpenHoof instances one CEO and many agents
...
### How do I completely reset OpenHoof but keep it installed
...
```bash
openhoof reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `OPENHOOF_PROFILE`), reset each state dir (defaults are `~/.openhoof-<profile>`).
- Dev reset: `openhoof gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), OpenHoof skips the heartbeat run to save API calls.
...
No. OpenHoof runs on **your own account**, so if you're in the group, OpenHoof can see it.
...
```bash
openhoof directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why does OpenHoof not reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.openhoof/agents/<agentId>/sessions/`.
...
- Use `openhoof doctor` to spot stray workspaces and profile mismatches.
...
OpenHoof's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, OpenHoof currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
4. Run `openhoof onboard` and choose `Ollama`
...
- for manual switching, use `openhoof models list` and `openhoof models set ollama/<model>`
...
- `openhoof models set ...` (updates just model config)
- `openhoof configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.openhoof/openhoof.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `openhoof doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do OpenHoof, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `openhoof models status`.
...
Yes. OpenHoof ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.openhoof/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `openhoof agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so OpenHoof can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.openhoof/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.openhoof/agent/*` (migrated by `openhoof doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.openhoof/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `openhoof models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `openhoof models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `openhoof models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.openhoof/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    openhoof models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), OpenHoof will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: OpenHoof now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
OpenHoof uses provider-prefixed IDs like:
...
OpenHoof may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `openhoof models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
openhoof models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
openhoof models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
openhoof models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
openhoof models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key - what is the difference

OpenHoof supports both:
...
```
--port > OPENHOOF_GATEWAY_PORT > gateway.port > default 18789
```

### Why does openhoof gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `openhoof gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does openhoof gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `OPENHOOF_STATE_DIR` mismatch).

Fix:

```bash
openhoof gateway install --force
```
...
OpenHoof enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `openhoof gateway --port <port>`.

### How do I run OpenHoof in remote mode client connects to a Gateway elsewhere
...
- `openhoof gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `openhoof dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `openhoof doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `OPENHOOF_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- If mismatch persists after the one retry, rotate/re-approve the paired device token:
  - `openhoof devices list`
  - `openhoof devices rotate --device <id> --role operator`
- Still stuck? Run `openhoof status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `OPENHOOF_CONFIG_PATH` (per-instance config)
- `OPENHOOF_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `openhoof --profile <name> …` per instance (auto-creates `~/.openhoof-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `openhoof --profile <name> gateway install`.

Profiles also suffix service names (`ai.openhoof.<profile>`; legacy `com.openhoof.*`, `openhoof-gateway-<profile>.service`, `OpenHoof Gateway (<profile>)`).
...
```
openhoof tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/openhoof/openhoof-YYYY-MM-DD.log
```
...
- macOS: `$OPENHOOF_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.openhoof/logs/...`; profiles use `~/.openhoof-<profile>/logs/...`)
- Linux: `journalctl --user -u openhoof-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "OpenHoof Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `openhoof gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart OpenHoof
...
1. Is the Gateway running? `openhoof gateway status`
2. Is the Gateway healthy? `openhoof status`
3. Does the UI have the right token? `openhoof dashboard`
...
```bash
openhoof channels status
openhoof channels logs --channel telegram
```

Then match the error:

- `BOT_COMMANDS_TOO_MUCH`: the Telegram menu has too many entries. OpenHoof already trims to the Telegram limit and retries with fewer commands, but some menu entries still need to be dropped. Reduce plugin/skill/custom commands, or disable `channels.telegram.commands.native` if you do not need the menu.
...
### ELI5 openhoof gateway restart vs openhoof gateway

- `openhoof gateway restart`: restarts the **background service** (launchd/systemd).
- `openhoof gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `openhoof gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [OpenHoof assistant setup](/start/openhoof) and [Agent send](/tools/agent-send).

CLI sending:

```bash
openhoof message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose OpenHoof to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `openhoof pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `openhoof pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `openhoof doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. OpenHoof only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
openhoof pairing approve whatsapp <code>
```

List pending requests:

```bash
openhoof pairing list whatsapp
```
...
OpenHoof blocks **cross-provider** messaging by default. If a tool call is bound
