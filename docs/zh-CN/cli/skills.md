...
summary: "`openhoof skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
- HoofHub 安装：[HoofHub](/tools/hoofhub)

## 命令

```bash
openhoof skills list
openhoof skills list --eligible
openhoof skills info <name>
openhoof skills check
```
