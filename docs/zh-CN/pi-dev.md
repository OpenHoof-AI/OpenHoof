...
本指南总结了在 OpenHoof 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenHoof 状态目录下。默认为 `~/.openhoof`。如果设置了 `OPENHOOF_STATE_DIR`，则使用该目录。
...
- https://docs.openhoof.ai/testing
- https://docs.openhoof.ai/start/getting-started
