...
You can point OpenHoof at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenHoof
...
- [Anthropic provider](/providers/anthropic) - Native OpenHoof integration with Claude setup-token or API keys
