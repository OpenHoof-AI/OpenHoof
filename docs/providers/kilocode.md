---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in OpenHoof"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in OpenHoof
---
...
```bash
openhoof onboard --kilocode-api-key <key>
```
...
OpenHoof dynamically discovers available models from the Kilo Gateway at startup. Use
