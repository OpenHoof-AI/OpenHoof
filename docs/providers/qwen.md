---
summary: "Use Qwen OAuth (free tier) in OpenHoof"
read_when:
  - You want to use Qwen with OpenHoof
...
If you already logged in with the Qwen Code CLI, OpenHoof will sync credentials
