---
summary: "Use Qianfan's unified API to access many models in OpenHoof"
read_when:
...
3. OpenHoof installed on your system
...
4. Copy the API key for use with OpenHoof

## CLI setup

```bash
openhoof onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenHoof Configuration](/gateway/configuration)
