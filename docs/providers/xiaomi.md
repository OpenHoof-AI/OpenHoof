---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenHoof"
read_when:
  - You want Xiaomi MiMo models in OpenHoof
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenHoof uses
...
```bash
openhoof onboard --auth-choice xiaomi-api-key
# or non-interactive
openhoof onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
