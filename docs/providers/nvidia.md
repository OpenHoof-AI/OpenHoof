---
summary: "Use NVIDIA's OpenAI-compatible API in OpenHoof"
read_when:
  - You want to use NVIDIA models in OpenHoof
...
openhoof onboard --auth-choice skip
openhoof models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
