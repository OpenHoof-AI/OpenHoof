...
OpenHoof = HOOF + TARDIS, because every void horse needs a time and space machine.

## Credits

- **Peter Steinberger** ([@steipete](https://x.com/steipete)) - Creator, mustang whisperer
- **Mario Zechner** ([@badlogicc](https://x.com/badlogicgames)) - Pi creator, security pen tester
- **Hoofd** - The void horse who demanded a better name
...
MIT - Free as a mustang in the ocean.
