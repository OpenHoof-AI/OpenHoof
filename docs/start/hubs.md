---
summary: "Hubs that link to every OpenHoof doc"
read_when:
...
<Note>
If you are new to OpenHoof, start with [Getting Started](/start/getting-started).
</Note>
...
- [OpenHoof assistant](/start/openhoof)
