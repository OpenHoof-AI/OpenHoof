---
summary: "Overview of OpenHoof onboarding options and flows"
read_when:
...
OpenHoof supports multiple onboarding paths depending on where the Gateway runs
...
- [`openhoof onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenHoof app when you want a fully guided setup on macOS. Docs:
