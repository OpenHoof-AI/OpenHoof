---
summary: "First-run setup flow for OpenHoof (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenHoof">
...
<Step title="CLI">
  ...
  The app can install the global `openhoof` CLI via npm/pnpm so terminal
