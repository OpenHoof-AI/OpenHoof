...
- Install via CLI: `openhoof plugins install @openhoof/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openhoof plugins install ./extensions/zalo`
   - From npm (if published): `openhoof plugins install @openhoof/zalo`
...
This page reflects current OpenHoof behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `openhoof pairing list zalo`
  - `openhoof pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in OpenHoof.
...
- Example: `openhoof message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openhoof channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openhoof logs --follow`
