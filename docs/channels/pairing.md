...
read_when:
  ...
  - Reviewing OpenHoof security posture
title: "Pairing"
---

# Pairing

“Pairing” is OpenHoof’s explicit **owner approval** step.
...
Stored under `~/.openhoof/credentials/`:
...
3. On your phone, open the OpenHoof iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `openhoof nodes pending/approve`) is a
