...
export function listWhatsAppAuthDirs(cfg: OpenHoofConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenHoofConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenHoofConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenHoofConfig): ResolvedWhatsAppAccount[] {
