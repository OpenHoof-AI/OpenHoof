...
const CONFIG_KEY = Symbol.for("openhoof:testConfigMock");
...
vi.mock("openhoof/plugin-sdk/media-runtime", async (importOriginal) => {
...
vi.mock("@whiskeysockets/baileys", () => {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("openhoof:lastSocket")] =
    created.lastSocket;
  return created.mod;
});
...
export function getLastSocket(): MockBaileysSocket {
  const getter = (globalThis as Record<PropertyKey, unknown>)[Symbol.for("openhoof:lastSocket")];
  if (typeof getter === "function") {
