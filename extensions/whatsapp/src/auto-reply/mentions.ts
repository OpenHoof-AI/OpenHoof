...
import { buildMentionRegexes, normalizeMentionText } from "openhoof/plugin-sdk/reply-runtime";
import { isSelfChatMode, jidToE164, normalizeE164 } from "openhoof/plugin-sdk/text-runtime";
