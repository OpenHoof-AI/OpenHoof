...
import { SafeOpenError, readLocalFileSafely } from "openhoof/plugin-sdk/infra-runtime";
import type { SsrFPolicy } from "openhoof/plugin-sdk/infra-runtime";
import { type MediaKind, maxBytesForKind } from "openhoof/plugin-sdk/media-runtime";
import { fetchRemoteMedia } from "openhoof/plugin-sdk/media-runtime";
import {
  convertHeicToJpeg,
  hasAlphaChannel,
  optimizeImageToPng,
...
import { getDefaultMediaLocalRoots } from "openhoof/plugin-sdk/media-runtime";
import { detectMime, extensionForMime, kindFromMime } from "openhoof/plugin-sdk/media-runtime";
import { logVerbose, shouldLogVerbose } from "openhoof/plugin-sdk/runtime-env";
import { resolveUserPath } from "openhoof/plugin-sdk/text-runtime";
...
async function assertLocalMediaAllowed(
  ...
  // Hardening: the default allowlist includes the OpenHoof temp dir, and tests/CI may
