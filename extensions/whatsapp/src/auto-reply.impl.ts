export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "openhoof/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "openhoof/plugin-sdk/reply-runtime";
