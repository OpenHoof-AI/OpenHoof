...
import type { OpenHoofConfig } from "../../../src/config/config.js";
...
type ResolveConfiguredBindingRouteFn =
  typeof import("openhoof/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("openhoof/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/openhoof-sessions.json");
