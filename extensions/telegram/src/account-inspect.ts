import { resolveAccountWithDefaultFallback } from "openhoof/plugin-sdk/account-resolution";
...
import { tryReadSecretFileSync } from "openhoof/plugin-sdk/infra-runtime";
import { resolveDefaultSecretProviderAlias } from "openhoof/plugin-sdk/provider-auth";
...
function inspectTokenValue(params: { cfg: OpenHoofConfig; value: unknown }): {
  token: string;
