...
import type { TelegramNetworkConfig } from "openhoof/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "openhoof/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "openhoof/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "OPENHOOF_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "OPENHOOF_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "OPENHOOF_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable OPENHOOF_TELEGRAM_DNS_RESULT_ORDER
