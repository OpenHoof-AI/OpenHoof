...
} from "openhoof/plugin-sdk/allowlist-config-edit";
import { createScopedDmSecurityResolver } from "openhoof/plugin-sdk/channel-config-helpers";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "openhoof/plugin-sdk/channel-policy";
import {
...
import { buildOutboundBaseSessionKey, normalizeOutboundThreadId } from "openhoof/plugin-sdk/core";
import { resolveExecApprovalCommandDisplay } from "openhoof/plugin-sdk/infra-runtime";
import { buildExecApprovalPendingReplyPayload } from "openhoof/plugin-sdk/infra-runtime";
import { resolveThreadSessionKeys, type RoutePeer } from "openhoof/plugin-sdk/routing";
...
function hasTelegramExecApprovalDmRoute(cfg: OpenHoofConfig): boolean {
...
export const telegramPlugin: ChannelPlugin<ResolvedTelegramAccount, TelegramProbe> = {
  ...
  gateway: {
    ...
    logoutAccount: async ({ accountId, cfg }) => {
      ...
      const nextCfg = { ...cfg } as OpenHoofConfig;
