...
import { MediaFetchError } from "openhoof/plugin-sdk/media-runtime";
import { resetInboundDedupe } from "openhoof/plugin-sdk/reply-runtime";
import type { GetReplyOptions, MsgContext } from "openhoof/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("openhoof/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as OpenHoofConfig) as TelegramBotDeps["loadConfig"],
...
vi.doMock("openhoof/plugin-sdk/media-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/media-runtime")>();
...
vi.doMock("openhoof/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
