...
import { createFinalizableDraftLifecycle } from "openhoof/plugin-sdk/channel-runtime";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("openhoof.telegramDraftStreamState");
