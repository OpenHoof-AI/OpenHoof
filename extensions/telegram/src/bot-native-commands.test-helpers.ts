...
import type { TelegramAccountConfig } from "openhoof/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("openhoof/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("openhoof/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("openhoof/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("openhoof/plugin-sdk/channel-runtime").recordInboundSessionMetaSafe;
...
vi.mock("openhoof/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("openhoof/plugin-sdk/reply-runtime", async (importOriginal) => {
...
vi.mock("openhoof/plugin-sdk/channel-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/channel-runtime")>();
  return {
    ...actual,
...
vi.mock("openhoof/plugin-sdk/conversation-runtime", async (importOriginal) => {
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as OpenHoofConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as OpenHoofConfig),
