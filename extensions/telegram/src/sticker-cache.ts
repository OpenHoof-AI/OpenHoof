...
import { resolveApiKeyForProvider } from "openhoof/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "openhoof/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "openhoof/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "openhoof/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "openhoof/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "openhoof/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "openhoof/plugin-sdk/runtime-env";
import { STATE_DIR } from "openhoof/plugin-sdk/state-paths";
