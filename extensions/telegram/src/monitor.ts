...
import { resolveAgentMaxConcurrent } from "openhoof/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "openhoof/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: OpenHoofConfig): RunOptions<unknown> {
  return {
    sink: {
