...
vi.mock("openhoof/plugin-sdk/config-runtime", async (importOriginal) => {
...
vi.mock("openhoof/plugin-sdk/infra-runtime", async (importOriginal) => {
...
vi.mock("openhoof/plugin-sdk/runtime-env", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/runtime-env")>();
  return {
    ...actual,
