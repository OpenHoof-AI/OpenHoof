...
import { resolveExecApprovalSessionTarget } from "openhoof/plugin-sdk/infra-runtime";
import type { ExecApprovalRequest, ExecApprovalResolved } from "openhoof/plugin-sdk/infra-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "openhoof/plugin-sdk/routing";
...
function isHandlerConfigured(params: { cfg: OpenHoofConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
