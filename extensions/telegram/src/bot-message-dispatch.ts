...
import {
  ...
  loadModelCatalog,
  modelSupportsVision,
} from "openhoof/plugin-sdk/agent-runtime";
import { resolveDefaultModelForAgent } from "openhoof/plugin-sdk/agent-runtime";
import { removeAckReactionAfterReply } from "openhoof/plugin-sdk/channel-runtime";
import { logAckFailure, logTypingFailure } from "openhoof/plugin-sdk/channel-runtime";
...
import { clearHistoryEntriesIfEnabled } from "openhoof/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: OpenHoofConfig, agentId: string) {
  try {
