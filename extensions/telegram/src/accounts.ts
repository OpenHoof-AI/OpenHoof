...
import { isTruthyEnvValue } from "openhoof/plugin-sdk/infra-runtime";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "openhoof/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "openhoof/plugin-sdk/routing";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPENHOOF_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: OpenHoofConfig): string[] {
...
export function listTelegramAccountIds(cfg: OpenHoofConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpenHoofConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/openhoof/openhoof/issues/30673
...
export function listEnabledTelegramAccounts(cfg: OpenHoofConfig): ResolvedTelegramAccount[] {
