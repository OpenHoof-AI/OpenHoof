...
import { resetInboundDedupe } from "openhoof/plugin-sdk/reply-runtime";
import type { MsgContext } from "openhoof/plugin-sdk/reply-runtime";
import type { GetReplyOptions, ReplyPayload } from "openhoof/plugin-sdk/reply-runtime";
import type { MockFn } from "openhoof/plugin-sdk/testing";
import { beforeEach, vi } from "vitest";
import type { TelegramBotDeps } from "./bot-deps.js";

type AnyMock = ReturnType<typeof vi.fn>;
type AnyAsyncMock = ReturnType<typeof vi.fn>;
type LoadConfigFn = typeof import("openhoof/plugin-sdk/config-runtime").loadConfig;
type ResolveStorePathFn = typeof import("openhoof/plugin-sdk/config-runtime").resolveStorePath;
type TelegramBotRuntimeForTest = NonNullable<
  Parameters<typeof import("./bot.js").setTelegramBotRuntimeForTest>[0]
>;
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("openhoof/plugin-sdk/reply-runtime").dispatchReplyWithBufferedBlockDispatcher;
...
const { sessionStorePath } = vi.hoisted(() => ({
  sessionStorePath: `/tmp/openhoof-telegram-${process.pid}-${process.env.VITEST_POOL_ID ?? "0"}.json`,
}));
...
vi.doMock("openhoof/plugin-sdk/web-media", () => ({
  loadWebMedia,
}));
...
vi.doMock("openhoof/plugin-sdk/config-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/config-runtime")>();
  return {
    ...actual,
    loadConfig,
...
vi.doMock("openhoof/plugin-sdk/conversation-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/conversation-runtime")>();
  return {
    ...actual,
...
vi.doMock("openhoof/plugin-sdk/reply-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/reply-runtime")>();
  return {
    ...actual,
...
vi.doMock("openhoof/plugin-sdk/infra-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/infra-runtime")>();
  return {
    ...actual,
...
const DEFAULT_TELEGRAM_TEST_CONFIG: OpenHoofConfig = {
  agents: {
    defaults: {
