import { formatAllowFromLowercase } from "openhoof/plugin-sdk/allow-from";
import { createTopLevelChannelConfigAdapter } from "openhoof/plugin-sdk/channel-config-helpers";
import {
...
import { listDirectoryEntriesFromSources } from "openhoof/plugin-sdk/directory-runtime";
import { createLazyRuntimeNamedExport } from "openhoof/plugin-sdk/lazy-runtime";
import type { ChannelMessageActionName, ChannelPlugin, OpenHoofConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: OpenHoofConfig) => ({
