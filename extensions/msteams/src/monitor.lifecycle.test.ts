...
import type { OpenHoofConfig, RuntimeEnv } from "openhoof/plugin-sdk/msteams";
...
vi.mock("openhoof/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): OpenHoofConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
