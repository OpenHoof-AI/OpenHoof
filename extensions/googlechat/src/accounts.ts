...
import { isSecretRef, type OpenHoofConfig } from "openhoof/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: OpenHoofConfig): ResolvedGoogleChatAccount[] {
