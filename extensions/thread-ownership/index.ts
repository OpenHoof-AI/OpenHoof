import { definePluginEntry, type OpenHoofConfig, type OpenHoofPluginApi } from "./api.js";
...
function resolveOwnershipAgent(config: OpenHoofConfig): { id: string; name: string } {
