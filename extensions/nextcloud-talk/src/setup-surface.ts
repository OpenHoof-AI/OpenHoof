...
import { hasConfiguredSecretInput } from "openhoof/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "openhoof/plugin-sdk/routing";
import { setSetupChannelEnabled } from "openhoof/plugin-sdk/setup";
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "OpenHoof" "<shared-secret>" "<webhook-url>" --feature reaction',
