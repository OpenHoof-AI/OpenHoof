...
function mergeZalouserAccountConfig(cfg: OpenHoofConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: OpenHoofConfig; accountId?: string | null }) {
