...
import { loadConfig, type OpenHoofConfig } from "openhoof/plugin-sdk/config-runtime";
...
import { maxBytesForKind } from "openhoof/plugin-sdk/media-runtime";
import { extensionForMime } from "openhoof/plugin-sdk/media-runtime";
import { unlinkIfExists } from "openhoof/plugin-sdk/media-runtime";
import type { PollInput } from "openhoof/plugin-sdk/media-runtime";
...
import { loadWebMediaRaw } from "openhoof/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredOpenHoofTmpDir();
