...
import { resolveHumanDelayConfig } from "openhoof/plugin-sdk/agent-runtime";
import { createReplyPrefixOptions } from "openhoof/plugin-sdk/channel-runtime";
import { recordInboundSession } from "openhoof/plugin-sdk/channel-runtime";
import type { OpenHoofConfig } from "openhoof/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "openhoof/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "openhoof/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "openhoof/plugin-sdk/config-runtime";
import type { DiscordAccountConfig } from "openhoof/plugin-sdk/config-runtime";
import {
  buildPluginBindingResolvedText,
  parsePluginBindingApprovalCustomId,
  resolvePluginConversationBindingApproval,
} from "openhoof/plugin-sdk/conversation-runtime";
import { enqueueSystemEvent } from "openhoof/plugin-sdk/infra-runtime";
import { getAgentScopedMediaLocalRoots } from "openhoof/plugin-sdk/media-runtime";
import { dispatchPluginInteractiveHandler } from "openhoof/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "openhoof/plugin-sdk/reply-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "openhoof/plugin-sdk/reply-runtime";
import { finalizeInboundContext } from "openhoof/plugin-sdk/reply-runtime";
import { dispatchReplyWithBufferedBlockDispatcher } from "openhoof/plugin-sdk/reply-runtime";
import { createReplyReferencePlanner } from "openhoof/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "openhoof/plugin-sdk/routing";
import { logVerbose } from "openhoof/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "openhoof/plugin-sdk/runtime-env";
import { logDebug, logError } from "openhoof/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__openhoof_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__openhoof_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__openhoof_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__openhoof_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__openhoof_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__openhoof_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "OpenHoof form";
  customId = "__openhoof_discord_component_modal_wildcard__";
  components = [];
