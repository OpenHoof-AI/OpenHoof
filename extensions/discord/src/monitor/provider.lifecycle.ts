...
import { createArmableStallWatchdog } from "openhoof/plugin-sdk/channel-runtime";
import { createConnectedChannelStatusPatch } from "openhoof/plugin-sdk/gateway-runtime";
import { danger } from "openhoof/plugin-sdk/runtime-env";
...
export async function runDiscordGatewayLifecycle(params: {
  ...
  try {
    ...
    // Carbon starts the gateway during client construction, before OpenHoof can
