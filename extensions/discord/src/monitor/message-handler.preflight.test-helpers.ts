...
export type DiscordConfig = NonNullable<OpenHoofConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("openhoof/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "openhoof-bot",
