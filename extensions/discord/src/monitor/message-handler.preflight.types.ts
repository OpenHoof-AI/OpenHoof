...
import type { SessionBindingRecord } from "openhoof/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "openhoof/plugin-sdk/reply-runtime";
import type { resolveAgentRoute } from "openhoof/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("openhoof/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("openhoof/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("openhoof/plugin-sdk/config-runtime").OpenHoofConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
