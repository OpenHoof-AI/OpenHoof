...
function createConfig(): OpenHoofConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: OpenHoofConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: OpenHoofConfig; name: string }) {
  const createDiscordNativeCommand = await loadCreateDiscordNativeCommand();
  return createDiscordNativeCommand({
    command: {
      name: params.name,
...
async function createStatusCommand(cfg: OpenHoofConfig) {
