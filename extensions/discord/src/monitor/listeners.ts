...
import { formatDurationSeconds } from "openhoof/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("openhoof/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("openhoof/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("openhoof/plugin-sdk/runtime-env").createSubsystemLogger>;
