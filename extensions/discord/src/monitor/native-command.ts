...
import { resolveCommandAuthorizedFromAuthorizers } from "openhoof/plugin-sdk/channel-runtime";
import { resolveNativeCommandSessionTargets } from "openhoof/plugin-sdk/channel-runtime";
import { createReplyPrefixOptions } from "openhoof/plugin-sdk/channel-runtime";
import type { OpenHoofConfig, loadConfig } from "openhoof/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "openhoof/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "openhoof/plugin-sdk/config-runtime";
import {
  ensureConfiguredBindingRouteReady,
  resolveConfiguredBindingRoute,
} from "openhoof/plugin-sdk/conversation-runtime";
import { buildPairingReply } from "openhoof/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "openhoof/plugin-sdk/media-runtime";
import { executePluginCommand, matchPluginCommand } from "openhoof/plugin-sdk/plugin-runtime";
import {
  resolveSendableOutboundReplyParts,
  resolveTextChunksWithFallback,
} from "openhoof/plugin-sdk/reply-payload";
...
import { dispatchReplyWithDispatcher } from "openhoof/plugin-sdk/reply-runtime";
import type { ReplyPayload } from "openhoof/plugin-sdk/reply-runtime";
import { logVerbose } from "openhoof/plugin-sdk/runtime-env";
import { createSubsystemLogger } from "openhoof/plugin-sdk/runtime-env";
import { loadWebMedia } from "openhoof/plugin-sdk/web-media";
...
type DiscordConfig = NonNullable<OpenHoofConfig["channels"]>["discord"];
