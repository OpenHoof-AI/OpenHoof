...
import { createOpenProviderConfiguredRouteWarningCollector } from "openhoof/plugin-sdk/channel-policy";
import {
...
function hasDiscordExecApprovalDmRoute(cfg: OpenHoofConfig): boolean {
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). OpenHoof adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
