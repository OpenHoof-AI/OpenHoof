...
import { resolveAgentDir } from "openhoof/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "openhoof/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "openhoof/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "openhoof/plugin-sdk/config-runtime";
import { formatErrorMessage } from "openhoof/plugin-sdk/infra-runtime";
import { resolvePreferredOpenHoofTmpDir } from "openhoof/plugin-sdk/infra-runtime";
import { transcribeAudioFile } from "openhoof/plugin-sdk/media-understanding-runtime";
...
import { parseTtsDirectives } from "openhoof/plugin-sdk/speech";
import { textToSpeech } from "openhoof/plugin-sdk/speech-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: OpenHoofConfig; override?: TtsConfig }): {
  cfg: OpenHoofConfig;
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredOpenHoofTmpDir(), "discord-voice-"));
