...
vi.mock("openhoof/plugin-sdk/routing", () => ({
...
vi.mock("openhoof/plugin-sdk/channel-runtime", () => ({
...
vi.mock("openhoof/plugin-sdk/config-runtime", () => ({
...
export function resetSlackSlashMocks() {
  ...
  mocks.resolveStorePathMock.mockReset().mockReturnValue("/tmp/openhoof-sessions.json");
}
