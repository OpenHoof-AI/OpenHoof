...
import { resolveSessionKey, type SessionScope } from "openhoof/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "openhoof/plugin-sdk/config-runtime";
import { createDedupeCache } from "openhoof/plugin-sdk/infra-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("openhoof/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
