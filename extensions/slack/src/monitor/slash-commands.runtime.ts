...
type BuildCommandTextFromArgs =
  typeof import("openhoof/plugin-sdk/reply-runtime").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("openhoof/plugin-sdk/reply-runtime").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("openhoof/plugin-sdk/reply-runtime").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("openhoof/plugin-sdk/reply-runtime").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("openhoof/plugin-sdk/reply-runtime").resolveCommandArgMenu;
