...
import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "openhoof/plugin-sdk/config-runtime";
import {
...
import { resolveAgentRoute as resolveAgentRouteImpl } from "openhoof/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("openhoof/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("openhoof/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("openhoof/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("openhoof/plugin-sdk/channel-runtime").resolveConversationLabel;
type CreateReplyPrefixOptions =
  typeof import("openhoof/plugin-sdk/channel-runtime").createReplyPrefixOptions;
type RecordInboundSessionMetaSafe =
  typeof import("openhoof/plugin-sdk/channel-runtime").recordInboundSessionMetaSafe;
type ResolveMarkdownTableMode =
  typeof import("openhoof/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("openhoof/plugin-sdk/routing").resolveAgentRoute;
