...
function createApi(params: {
  ...
  return createTestPluginApi({
    ...
    } as OpenHoofPluginApi["runtime"],
    registerCommand: params.registerCommand,
  }) as OpenHoofPluginApi;
}
...
describe("phone-control plugin", () => {
  it("arms sms.send as part of the writes group", async () => {
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "openhoof-phone-control-test-"));
    try {
      ...
      let command: OpenHoofPluginCommandDefinition | undefined;
