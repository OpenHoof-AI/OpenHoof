...
import { parseDurationMs } from "openhoof/plugin-sdk/cli-runtime";
import {
  definePluginEntry,
...
import { normalizeModelCompat } from "openhoof/plugin-sdk/provider-models";
import { fetchClaudeUsage } from "openhoof/plugin-sdk/provider-usage";
...
function buildAnthropicAuthDoctorHint(params: {
  ...
  return [
    ...
    `Fix: run "${formatCliCommand("openhoof doctor --yes")}"`,
  ].join("\n");
}
