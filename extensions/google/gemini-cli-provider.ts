...
import { fetchGeminiUsage } from "openhoof/plugin-sdk/provider-usage";
...
const ENV_VARS = [
  "OPENHOOF_GEMINI_OAUTH_CLIENT_ID",
  "OPENHOOF_GEMINI_OAUTH_CLIENT_SECRET",
...
export function registerGoogleGeminiCliProvider(api: OpenHoofPluginApi) {
