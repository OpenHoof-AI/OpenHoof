...
import type { OpenHoofPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "openhoof.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): OpenHoofPluginConfigSchema {
  return {
