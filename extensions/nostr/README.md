...
Nostr DM channel plugin for OpenHoof using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OpenHoof. It enables your bot to:
...
# Configure openhoof to use local relay
