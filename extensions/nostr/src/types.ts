...
} from "openhoof/plugin-sdk/account-id";
...
function resolveConfiguredDefaultNostrAccountId(cfg: OpenHoofConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: OpenHoofConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: OpenHoofConfig): string {
