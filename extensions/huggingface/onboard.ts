...
export function applyHuggingfaceProviderConfig(cfg: OpenHoofConfig): OpenHoofConfig {
...
export function applyHuggingfaceConfig(cfg: OpenHoofConfig): OpenHoofConfig {
