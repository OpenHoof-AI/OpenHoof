...
import { createAllowlistProviderRestrictSendersWarningCollector } from "openhoof/plugin-sdk/channel-policy";
import {
...
import { resolveOutboundMediaUrls } from "openhoof/plugin-sdk/reply-payload";
import {
...
const resolveLineDmPolicy = createScopedDmSecurityResolver<ResolvedLineAccount>({
  ...
  approveHint: "openhoof pairing approve line <code>",
...
export const linePlugin: ChannelPlugin<ResolvedLineAccount> = {
  ...
  pairing: createTextPairingAdapter({
    idLabel: "lineUserId",
    message: "OpenHoof: your access has been approved.",
