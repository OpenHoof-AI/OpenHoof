import type { ChannelSetupAdapter, OpenHoofConfig } from "openhoof/plugin-sdk/setup";
import {
  DEFAULT_ACCOUNT_ID,
  listLineAccountIds,
  normalizeAccountId,
...
export function isLineConfigured(cfg: OpenHoofConfig, accountId: string): boolean {
