import type { OpenHoofConfig, PluginRuntime, ResolvedLineAccount } from "openhoof/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: OpenHoofConfig; accountId: string }): Promise<{
