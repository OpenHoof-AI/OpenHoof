...
describe("diffs plugin registration", () => {
  ...
  it("applies plugin-config defaults through registered tool and viewer handler", async () => {
    ...
    type RegisteredHttpRouteParams = Parameters<OpenHoofPluginApi["registerHttpRoute"]>[0];
    ...
    const api = createTestPluginApi({
      ...
      runtime: {} as never,
      registerTool(tool: Parameters<OpenHoofPluginApi["registerTool"]>[0]) {
    ...
    plugin.register?.(api as unknown as OpenHoofPluginApi);
