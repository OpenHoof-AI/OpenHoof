...
export async function resolveTlonSetupConfigured(cfg: OpenHoofConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: OpenHoofConfig): Promise<string[]> {
