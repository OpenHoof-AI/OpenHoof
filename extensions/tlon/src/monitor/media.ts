...
import { fetchWithSsrFGuard } from "openhoof/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to OpenHoof workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".openhoof", "workspace", "media", "inbound");
 ...
 * Format matches OpenHoof's expected attachment structure.
 */
