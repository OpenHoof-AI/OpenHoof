...
import { resolveChannelMediaMaxBytes, type OpenHoofConfig } from "./runtime-api.js";
...
function resolveMediaLocalRoots(params: { cfg: OpenHoofConfig; accountId?: string }): string[] {
