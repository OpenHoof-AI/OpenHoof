...
function resolveBlueBubblesServerUrl(cfg: OpenHoofConfig, accountId: string): string | undefined {
  return resolveBlueBubblesAccount({ cfg, accountId }).config.serverUrl?.trim() || undefined;
}

function resolveBlueBubblesWebhookPath(cfg: OpenHoofConfig, accountId: string): string | undefined {
...
export const blueBubblesSetupWizard: ChannelSetupWizard = {
  ...
  completionNote: {
    ...
    lines: [
      ...
      "2. Add your OpenHoof gateway URL + webhook path",
