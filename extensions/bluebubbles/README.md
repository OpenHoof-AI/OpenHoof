...
This directory contains the **BlueBubbles external channel plugin** for OpenHoof.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `openhoof/plugin-sdk` helpers.
