...
import { loadConfig } from "openhoof/plugin-sdk/config-runtime";
import {
...
import { issuePairingChallenge } from "openhoof/plugin-sdk/conversation-runtime";
import {
  readChannelAllowFromStore,
  upsertChannelPairingRequest,
} from "openhoof/plugin-sdk/conversation-runtime";
import { normalizeScpRemoteHost } from "openhoof/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "openhoof/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "openhoof/plugin-sdk/media-runtime";
import { kindFromMime } from "openhoof/plugin-sdk/media-runtime";
import { resolveTextChunkLimit } from "openhoof/plugin-sdk/reply-runtime";
...
import { createReplyDispatcher } from "openhoof/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "openhoof/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "openhoof/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T openhoof@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., openhoof@192.168.64.3)
