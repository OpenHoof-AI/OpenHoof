...
function mergeIMessageAccountConfig(cfg: OpenHoofConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenHoofConfig): ResolvedIMessageAccount[] {
