...
function mergeZaloAccountConfig(cfg: OpenHoofConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OpenHoofConfig): ResolvedZaloAccount[] {
