...
import type { SignalAccountConfig } from "openhoof/plugin-sdk/signal-core";
...
function mergeSignalAccountConfig(cfg: OpenHoofConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenHoofConfig): ResolvedSignalAccount[] {
