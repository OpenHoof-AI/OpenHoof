import { resetSystemEventsForTest } from "openhoof/plugin-sdk/infra-runtime";
...
vi.mock("openhoof/plugin-sdk/reply-runtime", () => ({
...
vi.mock("openhoof/plugin-sdk/conversation-runtime", () => ({
...
vi.mock("openhoof/plugin-sdk/config-runtime", async (importOriginal) => {
  ...
  return {
    ...actual,
    resolveStorePath: vi.fn(() => "/tmp/openhoof-sessions.json"),
...
vi.mock("openhoof/plugin-sdk/infra-runtime", () => ({
