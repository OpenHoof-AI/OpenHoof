import { resolveActiveTalkProviderConfig } from "openhoof/plugin-sdk/config-runtime";
import type { SpeechVoiceOption } from "openhoof/plugin-sdk/speech";
import { definePluginEntry, type OpenHoofPluginApi } from "./api.js";
