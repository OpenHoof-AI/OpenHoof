 ...
 */
export function applyChutesProviderConfig(cfg: OpenHoofConfig): OpenHoofConfig {
 ...
 */
export function applyChutesConfig(cfg: OpenHoofConfig): OpenHoofConfig {
...
export function applyChutesApiKeyConfig(cfg: OpenHoofConfig): OpenHoofConfig {
