import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "openhoof/plugin-sdk/account-id";
import type { HoofbotConfig } from "../runtime-api.js";
 ...
 */
function listConfiguredAccountIds(cfg: HoofbotConfig): string[] {
 ...
 */
export function listFeishuAccountIds(cfg: HoofbotConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: HoofbotConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: HoofbotConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: HoofbotConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: HoofbotConfig): ResolvedFeishuAccount[] {
