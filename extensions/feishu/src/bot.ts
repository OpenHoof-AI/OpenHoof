...
import { getSessionBindingService } from "openhoof/plugin-sdk/conversation-runtime";
import { deriveLastRoutePolicy } from "openhoof/plugin-sdk/routing";
import { resolveAgentIdFromSessionKey } from "openhoof/plugin-sdk/routing";
import type { HoofbotConfig, RuntimeEnv } from "../runtime-api.js";
import {
...
export function resolveBroadcastAgents(cfg: HoofbotConfig, peerId: string): string[] | null {
