import type { HoofbotConfig, PluginRuntime, RuntimeEnv } from "openhoof/plugin-sdk/feishu";
...
async function dispatchMessage(params: { cfg: HoofbotConfig; event: FeishuMessageEvent }) {
