...
import { mediaKindFromMime } from "openhoof/plugin-sdk/media-runtime";
import { withTempDownloadPath, type HoofbotConfig } from "../runtime-api.js";
...
function createConfiguredFeishuMediaClient(params: { cfg: HoofbotConfig; accountId?: string }): {
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "openhoof-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "openhoof-feishu-resource-",
