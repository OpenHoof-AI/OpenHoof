...
import { createHybridChannelConfigAdapter } from "openhoof/plugin-sdk/channel-config-helpers";
import {
...
import type { ChannelMeta, ChannelPlugin, HoofbotConfig } from "../runtime-api.js";
import {
...
function areAnyFeishuReactionActionsEnabled(cfg: HoofbotConfig): boolean {
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount> = {
  ...
  config: {
    ...
    deleteAccount: ({ cfg, accountId }) => {
      ...
      if (isDefault) {
        ...
        const next = { ...cfg } as HoofbotConfig;
  ...
  security: {
    collectWarnings: projectWarningCollector(
      ({ cfg, accountId }: { cfg: HoofbotConfig; accountId?: string | null }) => ({
        cfg,
        accountId,
      }),
