...
import { jsonResult, readNumberParam, readStringParam } from "openhoof/plugin-sdk/agent-runtime";
import { optionalStringEnum } from "openhoof/plugin-sdk/core";
...
export function createFirecrawlScrapeTool(api: OpenHoofPluginApi) {
  return {
