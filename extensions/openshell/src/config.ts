...
import type { OpenHoofPluginConfigSchema } from "openhoof/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): OpenHoofPluginConfigSchema {
