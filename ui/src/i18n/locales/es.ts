...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.openhoof/openhoof.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde openhoof dashboard --no-open en tu escritorio.",
    },
    insecure: {
