...
declare global {
  interface Window {
    __OPENHOOF_CONTROL_UI_BASE_PATH__?: string;
  }
}
...
@customElement("openhoof-app")
export class OpenHoofApp extends LitElement {
  ...
  @state() theme: ThemeName = this.settings.theme ?? "hoof";
