    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="OpenHoof" />
          <div class="login-gate__title">OpenHoof</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="OPENHOOF_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
