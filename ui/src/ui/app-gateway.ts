...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "openhoof-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as OpenHoofApp);
      void loadAgents(host as unknown as OpenHoofApp);
      void loadHealthState(host as unknown as OpenHoofApp);
      void loadNodes(host as unknown as OpenHoofApp, { quiet: true });
      void loadDevices(host as unknown as OpenHoofApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as OpenHoofApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as OpenHoofApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as OpenHoofApp, payload);
