...
- Keep product names in English: OpenHoof, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the OpenHoof Gateway, use “Gateway 网关”.
