...
const (
	envDocsPiExecutable     = "OPENHOOF_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "OPENHOOF_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "OPENHOOF_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "openhoof", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
