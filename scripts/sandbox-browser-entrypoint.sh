...
export DISPLAY=:1
export HOME=/tmp/openhoof-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${OPENHOOF_BROWSER_CDP_PORT:-${HOOFBOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${OPENHOOF_BROWSER_CDP_SOURCE_RANGE:-${HOOFBOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${OPENHOOF_BROWSER_VNC_PORT:-${HOOFBOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${OPENHOOF_BROWSER_NOVNC_PORT:-${HOOFBOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${OPENHOOF_BROWSER_ENABLE_NOVNC:-${HOOFBOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${OPENHOOF_BROWSER_HEADLESS:-${HOOFBOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${OPENHOOF_BROWSER_NO_SANDBOX:-${HOOFBOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${OPENHOOF_BROWSER_NOVNC_PASSWORD:-${HOOFBOT_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${OPENHOOF_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${OPENHOOF_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${OPENHOOF_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
