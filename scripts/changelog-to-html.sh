...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenHoof $VERSION</h2>"
  echo "<p>Latest OpenHoof update.</p>"
  echo "<p><a href=\"https://github.com/openhoof/openhoof/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
