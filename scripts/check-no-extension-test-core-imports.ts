...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']openhoof\/plugin-sdk["']/,
    hint: "Use openhoof/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']openhoof\/plugin-sdk\/test-utils["']/,
    hint: "Use openhoof/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']openhoof\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or openhoof/plugin-sdk/testing for public surfaces.",
  },
  {
