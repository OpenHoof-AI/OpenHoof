...
- OPENHOOF_GATEWAY_VERSION = exact package.json version
- OPENHOOF_MARKETING_VERSION = short iOS/App Store version
- OPENHOOF_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
OPENHOOF_GATEWAY_VERSION = ${PACKAGE_VERSION}
OPENHOOF_MARKETING_VERSION = ${MARKETING_VERSION}
OPENHOOF_BUILD_VERSION = ${BUILD_NUMBER}
EOF
