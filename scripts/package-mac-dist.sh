...
# Output:
# - dist/OpenHoof.app
# - dist/OpenHoof-<version>.zip
# - dist/OpenHoof-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.openhoof.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/OpenHoof.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenHoof-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenHoof-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenHoof-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenHoof-$VERSION.dSYM.zip"
