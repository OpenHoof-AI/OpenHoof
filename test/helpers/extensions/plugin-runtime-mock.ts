import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "openhoof/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "openhoof/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "openhoof/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/openhoof"),
    },
    modelAuth: {
