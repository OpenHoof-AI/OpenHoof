...
import ai.openhoof.app.ui.mobileAccentBorderStrong
...
import ai.openhoof.app.ui.mobileSurface
import ai.openhoof.app.ui.mobileText
import ai.openhoof.app.ui.mobileTextSecondary
import ai.openhoof.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.openhoof.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.openhoof.app.ui.mobileFontFamily,
