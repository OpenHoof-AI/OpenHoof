...
/// Menu contents for the OpenHoof menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About OpenHoof") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "OpenHoof Not Configured"
        case .remote:
            "Remote OpenHoof Active"
        case .local:
            "OpenHoof Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .openhoofSelectSettingsTab, object: tab)
        }
    }
