...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.openhoof", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenHoof windows, but below the system’s pop-up menus.
