...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.openhoof", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenHoofConfigFile.defaultWorkspaceURL() }
