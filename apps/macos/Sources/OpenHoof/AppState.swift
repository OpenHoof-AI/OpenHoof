...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenHoofConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenHoofConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: OpenHoofConfigFile.loadDict(),
        ...
        OpenHoofConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/openhoof"
        state.remoteCliPath = ""
        return state
    }
}
