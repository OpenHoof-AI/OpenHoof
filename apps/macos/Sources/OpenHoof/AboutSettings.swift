...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/openhoof/openhoof") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/openhoof/openhoof")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://openhoof.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OpenHoofBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenHoofBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenHoofGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenHoofGitCommit") as? String) ??
            "unknown"
    }
