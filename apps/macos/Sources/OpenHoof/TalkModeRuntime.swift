...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.openhoof", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.openhoof", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenHoofChatMessage] = messages.compactMap { item in
