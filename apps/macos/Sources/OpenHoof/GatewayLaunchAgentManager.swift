...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.openhoof", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".openhoof/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.openhoofCommand(
            subcommand: "gateway",
