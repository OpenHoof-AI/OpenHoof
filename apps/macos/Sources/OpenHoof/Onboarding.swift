...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenHoof"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "openhoof.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: OpenHoofChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g openhoof@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenHoofChatViewModel(
