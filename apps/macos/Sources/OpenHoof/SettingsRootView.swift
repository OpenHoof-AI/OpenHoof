...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openhoofSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenHoofPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenHoofPaths.stateDirURL.path
...
extension Notification.Name {
    static let openhoofSelectSettingsTab = Notification.Name("openhoofSelectSettingsTab")
}
