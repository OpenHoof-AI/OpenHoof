...
enum OpenHoofConfigFile {
    private static let logger = Logger(subsystem: "ai.openhoof", category: "config")
    ...
    static func stateDirURL() -> URL {
        OpenHoofPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OpenHoofPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-openhoof-config-file",
            "event": "config.write",
