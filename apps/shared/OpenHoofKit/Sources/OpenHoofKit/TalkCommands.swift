...
public enum OpenHoofTalkCommand: String, Codable, Sendable {
...
public struct OpenHoofTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenHoofTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
