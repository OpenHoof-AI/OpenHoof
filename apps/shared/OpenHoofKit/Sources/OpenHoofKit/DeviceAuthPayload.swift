...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: OpenHoofProtocol.AnyCodable]?
    {
        ...
        return [
            "id": OpenHoofProtocol.AnyCodable(identity.deviceId),
            "publicKey": OpenHoofProtocol.AnyCodable(publicKey),
            "signature": OpenHoofProtocol.AnyCodable(signature),
            "signedAt": OpenHoofProtocol.AnyCodable(signedAtMs),
            "nonce": OpenHoofProtocol.AnyCodable(nonce),
        ]
    }
}
