...
public typealias OpenHoofPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenHoofPlatformImage = UIImage
#endif

public struct OpenHoofChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenHoofChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenHoofChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenHoofChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenHoofChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenHoofChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenHoofChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenHoofChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenHoofChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenHoofChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenHoofChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenHoofChatMessageContent].self, forKey: .content) {
...
public struct OpenHoofChatHistoryPayload: Codable, Sendable {
...
public struct OpenHoofSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenHoofSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenHoofSessionPreviewItem]
}

public struct OpenHoofSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenHoofSessionPreviewEntry]

    public init(ts: Int, previews: [OpenHoofSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenHoofChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenHoofChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenHoofAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenHoofChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenHoofGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenHoofPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenHoofPlatformImage?
...
public struct OpenHoofChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
