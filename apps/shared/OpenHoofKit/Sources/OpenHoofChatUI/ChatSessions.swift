...
public struct OpenHoofChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct OpenHoofChatSessionsDefaults: Codable, Sendable {
...
public struct OpenHoofChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct OpenHoofChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: OpenHoofChatSessionsDefaults?
    public let sessions: [OpenHoofChatSessionEntry]
    ...
    public init(
        ...
        sessions: [OpenHoofChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
