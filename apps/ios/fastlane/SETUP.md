...
ASC_KEYCHAIN_SERVICE=openhoof-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.openhoof.client
# or
...
- The beta flow regenerates `apps/ios/OpenHoof.xcodeproj` from `apps/ios/project.yml` before archiving
