...
enum WatchMessagingError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .watchAppNotInstalled:
            "WATCH_UNAVAILABLE: OpenHoof watch companion app is not installed"
        }
    }
}
...
final class WatchMessagingService: NSObject, @preconcurrency WatchMessagingServicing {
    nonisolated private static let logger = Logger(subsystem: "ai.openhoof", category: "watch.messaging")
        ...
        params: OpenHoofWatchNotifyParams) async throws -> WatchNotificationSendResult
    {
        ...
        var payload: [String: Any] = [
            ...
            "title": params.title,
            "body": params.body,
            "priority": params.priority?.rawValue ?? OpenHoofNotificationPriority.active.rawValue,
