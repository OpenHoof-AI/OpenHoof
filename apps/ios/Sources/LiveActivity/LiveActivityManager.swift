...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.openhoof.ios", category: "LiveActivity")
    private var currentActivity: Activity<OpenHoofActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = OpenHoofActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<OpenHoofActivityAttributes>.activities
    ...
    private func updateCurrent(state: OpenHoofActivityAttributes.ContentState) {
    ...
    private func connectingState() -> OpenHoofActivityAttributes.ContentState {
        OpenHoofActivityAttributes.ContentState(
    ...
    private func idleState() -> OpenHoofActivityAttributes.ContentState {
        OpenHoofActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> OpenHoofActivityAttributes.ContentState {
        OpenHoofActivityAttributes.ContentState(
