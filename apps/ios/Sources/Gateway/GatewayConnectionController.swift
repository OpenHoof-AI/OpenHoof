...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [OpenHoofCapability.canvas.rawValue, OpenHoofCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(OpenHoofCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(OpenHoofCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = OpenHoofLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(OpenHoofCapability.location.rawValue) }

        caps.append(OpenHoofCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(OpenHoofCapability.watch.rawValue)
        }
        caps.append(OpenHoofCapability.photos.rawValue)
        caps.append(OpenHoofCapability.contacts.rawValue)
        caps.append(OpenHoofCapability.calendar.rawValue)
        caps.append(OpenHoofCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(OpenHoofCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            OpenHoofScreenCommand.record.rawValue,
            OpenHoofSystemCommand.notify.rawValue,
            OpenHoofChatCommand.push.rawValue,
        ...
        if caps.contains(OpenHoofCapability.camera.rawValue) {
            commands.append(OpenHoofCameraCommand.list.rawValue)
            commands.append(OpenHoofCameraCommand.snap.rawValue)
            commands.append(OpenHoofCameraCommand.clip.rawValue)
        }
        if caps.contains(OpenHoofCapability.location.rawValue) {
            commands.append(OpenHoofLocationCommand.get.rawValue)
        }
        if caps.contains(OpenHoofCapability.device.rawValue) {
            commands.append(OpenHoofDeviceCommand.status.rawValue)
            commands.append(OpenHoofDeviceCommand.info.rawValue)
        }
        if caps.contains(OpenHoofCapability.watch.rawValue) {
            commands.append(OpenHoofWatchCommand.status.rawValue)
            commands.append(OpenHoofWatchCommand.notify.rawValue)
        }
        if caps.contains(OpenHoofCapability.photos.rawValue) {
            commands.append(OpenHoofPhotosCommand.latest.rawValue)
        }
        if caps.contains(OpenHoofCapability.contacts.rawValue) {
            commands.append(OpenHoofContactsCommand.search.rawValue)
            commands.append(OpenHoofContactsCommand.add.rawValue)
        }
        if caps.contains(OpenHoofCapability.calendar.rawValue) {
            commands.append(OpenHoofCalendarCommand.events.rawValue)
            commands.append(OpenHoofCalendarCommand.add.rawValue)
        }
        if caps.contains(OpenHoofCapability.reminders.rawValue) {
            commands.append(OpenHoofRemindersCommand.list.rawValue)
            commands.append(OpenHoofRemindersCommand.add.rawValue)
        }
        if caps.contains(OpenHoofCapability.motion.rawValue) {
            commands.append(OpenHoofMotionCommand.activity.rawValue)
            commands.append(OpenHoofMotionCommand.pedometer.rawValue)
        }
