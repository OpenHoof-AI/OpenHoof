...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.openhoof.gateway"
    private static let nodeService = "ai.openhoof.node"
    private static let talkService = "ai.openhoof.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.openhoof.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.openhoof.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("openhoof-gateway.log")
    }
