...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenHoofPhotosLatestParams) async throws -> OpenHoofPhotosLatestPayload {
        ...
        var results: [OpenHoofPhotoPayload] = []
        ...
        return OpenHoofPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenHoofPhotoPayload
    {
