...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.openhoof.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to OpenHoof", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to OpenHoof gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to OpenHoof.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "OpenHoofShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "OpenHoof is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "OpenHoof Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("openhoof-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
