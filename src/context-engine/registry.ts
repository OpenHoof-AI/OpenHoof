...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("openhoof.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("openhoof.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: OpenHoofConfig): Promise<ContextEngine> {
