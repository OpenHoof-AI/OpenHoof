...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set OPENHOOF_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `openhoof dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control OpenHoof.");
  } else if (hint) {
    runtime.log(hint);
  }
}
