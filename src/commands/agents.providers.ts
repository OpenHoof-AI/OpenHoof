...
function resolveDefaultAccountId(cfg: OpenHoofConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenHoofConfig): boolean {
...
export function summarizeBindings(cfg: OpenHoofConfig, bindings: AgentBinding[]): string[] {
