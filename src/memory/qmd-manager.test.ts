...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OpenHoofConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OpenHoofConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__openhoofMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__openhoofMcporterColdStartWarned;
  });
