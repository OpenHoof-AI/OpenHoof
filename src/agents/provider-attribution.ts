...
const OPENHOOF_ATTRIBUTION_PRODUCT = "OpenHoof";
const OPENHOOF_ATTRIBUTION_ORIGINATOR = "openhoof";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: OPENHOOF_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: OPENHOOF_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${OPENHOOF_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
