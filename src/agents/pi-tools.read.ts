...
function resolveAdaptiveReadMaxBytes(options?: OpenHoofReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOpenHoofReadTool(base, {
...
export function createOpenHoofReadTool(
  base: AnyAgentTool,
  options?: OpenHoofReadToolOptions,
): AnyAgentTool {
