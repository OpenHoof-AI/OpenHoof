...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/openhoof/openhoof/issues/31298
    previousFastTestEnv = process.env.OPENHOOF_TEST_FAST;
  ...
  afterAll(() => {
    if (previousFastTestEnv === undefined) {
      delete process.env.OPENHOOF_TEST_FAST;
      return;
    }
    process.env.OPENHOOF_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // OPENHOOF_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("OpenHoof runtime context (internal):");
