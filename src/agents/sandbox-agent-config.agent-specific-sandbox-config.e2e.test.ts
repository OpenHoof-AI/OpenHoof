...
async function resolveContext(config: OpenHoofConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): OpenHoofConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
