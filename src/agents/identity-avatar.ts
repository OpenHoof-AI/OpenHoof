...
function resolveAvatarSource(cfg: OpenHoofConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenHoofConfig, agentId: string): AgentAvatarResolution {
