...
export function isCliProvider(provider: string, cfg?: OpenHoofConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: OpenHoofConfig; agentId?: string }): string[] {
  if (params.agentId) {
