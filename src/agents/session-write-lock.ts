...
const CLEANUP_STATE_KEY = Symbol.for("openhoof.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("openhoof.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("openhoof.sessionWriteLockWatchdogState");
