...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenHoofAgentDir() returns mainAgentDir
    process.env.OPENHOOF_STATE_DIR = tmpDir;
    process.env.OPENHOOF_AGENT_DIR = mainAgentDir;
