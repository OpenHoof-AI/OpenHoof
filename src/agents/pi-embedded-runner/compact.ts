...
function resolvePostCompactionIndexSyncMode(config?: OpenHoofConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureOpenHoofModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createOpenHoofCodingTools({
      exec: {
