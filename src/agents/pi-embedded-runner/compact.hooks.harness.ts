...
export const createOpenHoofCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createOpenHoofCodingToolsMock.mockReset();
  createOpenHoofCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureOpenHoofModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveOpenHoofDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createOpenHoofCodingTools: createOpenHoofCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveOpenHoofAgentDir: vi.fn(() => "/tmp"),
  }));
