...
export const DEFAULT_SANDBOX_IMAGE = "openhoof-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openhoof-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openhoof-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openhoof-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openhoof-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "openhoof-sandbox-browser";
