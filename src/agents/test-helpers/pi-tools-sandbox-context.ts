...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "openhoof-sbx-test",
    runtimeLabel: params.containerName ?? "openhoof-sbx-test",
    containerName: params.containerName ?? "openhoof-sbx-test",
