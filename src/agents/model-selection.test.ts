...
function resolveAnthropicOpusThinking(cfg: OpenHoofConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<OpenHoofConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<OpenHoofConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<OpenHoofConfig> = {
        agents: {
          defaults: {
            models: {
