...
export function resolveSessionToolsVisibility(cfg: OpenHoofConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: OpenHoofConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: OpenHoofConfig): AgentToAgentPolicy {
