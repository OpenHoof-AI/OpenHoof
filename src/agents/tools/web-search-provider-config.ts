...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<OpenHoofConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<OpenHoofConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: OpenHoofConfig): WebSearchConfig {
