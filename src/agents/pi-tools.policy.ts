...
export function resolveSubagentToolPolicy(cfg?: OpenHoofConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: OpenHoofConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: OpenHoofConfig["tools"];
