...
type AgentEntry = NonNullable<NonNullable<OpenHoofConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: OpenHoofConfig): AgentEntry[] {
...
export function listAgentIds(cfg: OpenHoofConfig): string[] {
...
export function resolveDefaultAgentId(cfg: OpenHoofConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: OpenHoofConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: OpenHoofConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: OpenHoofConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
