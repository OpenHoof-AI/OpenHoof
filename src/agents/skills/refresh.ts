...
function resolveWatchPaths(workspaceDir: string, config?: OpenHoofConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpenHoofConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenHoofConfig }) {
