...
let originalOpenHoofTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalOpenHoofTestConsole = process.env.OPENHOOF_TEST_CONSOLE;
  process.env.OPENHOOF_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalOpenHoofTestConsole === undefined) {
    delete process.env.OPENHOOF_TEST_CONSOLE;
  } else {
    process.env.OPENHOOF_TEST_CONSOLE = originalOpenHoofTestConsole;
  }
