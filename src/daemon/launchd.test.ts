...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.openhoof.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.openhoof.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", OPENHOOF_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.openhoof.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when OPENHOOF_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.openhoof.gateway.plist",
    },
    {
      name: "uses profile-specific label when OPENHOOF_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", OPENHOOF_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.openhoof.jbphoenix.plist",
    },
    {
      name: "prefers OPENHOOF_LAUNCHD_LABEL over OPENHOOF_PROFILE",
      env: {
        HOME: "/Users/test",
        OPENHOOF_PROFILE: "jbphoenix",
        OPENHOOF_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from OPENHOOF_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        OPENHOOF_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty OPENHOOF_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        OPENHOOF_PROFILE: "myprofile",
        OPENHOOF_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.openhoof.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
