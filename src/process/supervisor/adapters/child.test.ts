...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.OPENHOOF_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.OPENHOOF_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.OPENHOOF_SERVICE_MARKER = originalServiceMarker;
    }
  });
