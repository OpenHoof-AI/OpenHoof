...
export const A2UI_PATH = "/__openhoof__/a2ui";

export const CANVAS_HOST_PATH = "/__openhoof__/canvas";

export const CANVAS_WS_PATH = "/__openhoof__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openhoofCanvasA2UIAction.postMessage(...)
  // - Android: window.openhoofCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openhoofCanvasA2UIAction"];
  ...
  globalThis.OpenHoof = globalThis.OpenHoof ?? {};
  globalThis.OpenHoof.postMessage = postToNode;
  globalThis.OpenHoof.sendUserAction = sendUserAction;
  globalThis.openhoofPostMessage = postToNode;
  globalThis.openhoofSendUserAction = sendUserAction;
