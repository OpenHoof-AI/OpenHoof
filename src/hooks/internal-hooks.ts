/**
 * Hook system for OpenHoof agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __openhoof_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__openhoof_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
