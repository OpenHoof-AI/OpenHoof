...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: OpenHoofConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: OpenHoofConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: OpenHoofConfig) => string;
  setAccountEnabled?: (params: {
    cfg: OpenHoofConfig;
    accountId: string;
    enabled: boolean;
  }) => OpenHoofConfig;
  deleteAccount?: (params: { cfg: OpenHoofConfig; accountId: string }) => OpenHoofConfig;
  isEnabled?: (account: ResolvedAccount, cfg: OpenHoofConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: OpenHoofConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: OpenHoofConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: OpenHoofConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: OpenHoofConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.openhoof.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: OpenHoofConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: OpenHoofConfig;
    nextCfg: OpenHoofConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: OpenHoofConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: OpenHoofConfig; accountId?: string | null }) =>
    | {
