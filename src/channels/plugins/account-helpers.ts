...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: OpenHoofConfig): string | undefined {
  ...
  function listAccountIds(cfg: OpenHoofConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: OpenHoofConfig): string {
