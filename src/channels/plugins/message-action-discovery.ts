...
export function listChannelMessageActions(cfg: OpenHoofConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: OpenHoofConfig): ChannelMessageCapability[] {
