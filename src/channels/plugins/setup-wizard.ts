...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: OpenHoofConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: OpenHoofConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: OpenHoofConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: OpenHoofConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: OpenHoofConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: OpenHoofConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: OpenHoofConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: OpenHoofConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: OpenHoofConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: OpenHoofConfig) => OpenHoofConfig;
