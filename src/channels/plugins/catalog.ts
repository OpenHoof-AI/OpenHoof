...
import { discoverOpenHoofPlugins } from "../../plugins/discovery.js";
import { loadPluginManifest } from "../../plugins/manifest.js";
import type { OpenHoofPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, OpenHoofPackageManifest>>;

const ENV_CATALOG_PATHS = ["OPENHOOF_PLUGIN_CATALOG_PATHS", "OPENHOOF_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<OpenHoofPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: OpenHoofPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  origin?: PluginOrigin;
  workspaceDir?: string;
  packageManifest?: OpenHoofPackageManifest;
