...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("openhoof");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "openhoof");
