      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["openhoof gateway run", "Run the gateway in the foreground."],
            ["openhoof gateway status", "Show service status and probe reachability."],
            ["openhoof gateway discover", "Find local and wide-area gateway beacons."],
            ["openhoof gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.openhoof.ai/cli/gateway")}\n`,
      ),
  );
