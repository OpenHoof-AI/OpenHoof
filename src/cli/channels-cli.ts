    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openhoof channels list", "List configured channels and auth profiles."],
          ["openhoof channels status --probe", "Run channel status checks and probes."],
          [
            "openhoof channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["openhoof channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.openhoof.ai/cli/channels",
        )}\n`,
    );
