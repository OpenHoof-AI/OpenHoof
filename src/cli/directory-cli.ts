    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openhoof directory self --channel slack", "Show the connected account identity."],
          [
            'openhoof directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["openhoof directory groups list --channel discord", "List available groups/channels."],
          [
            "openhoof directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.openhoof.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
