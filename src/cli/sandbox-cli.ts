...
const SANDBOX_EXAMPLES = {
  main: [
    ["openhoof sandbox list", "List all sandbox containers."],
    ["openhoof sandbox list --browser", "List only browser containers."],
    ["openhoof sandbox recreate --all", "Recreate all containers."],
    ["openhoof sandbox recreate --session main", "Recreate a specific session."],
    ["openhoof sandbox recreate --agent mybot", "Recreate agent containers."],
    ["openhoof sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["openhoof sandbox list", "List all sandbox containers."],
    ["openhoof sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["openhoof sandbox recreate --all", "Recreate all containers."],
    ["openhoof sandbox recreate --session main", "Recreate a specific session."],
    ["openhoof sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["openhoof sandbox recreate --browser --all", "Recreate only browser containers."],
    ["openhoof sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["openhoof sandbox explain", "Show effective sandbox config."],
    ["openhoof sandbox explain --session agent:main:main", "Explain a specific session."],
    ["openhoof sandbox explain --agent work", "Explain an agent sandbox."],
    ["openhoof sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.openhoof.ai/cli/sandbox")}\n`,
    )
    .action(() => {
