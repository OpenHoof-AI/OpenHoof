const DEFAULT_TAGLINE = "All your chats, one OpenHoof.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little hoof-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew hooves—type something and let the bot stomp the busywork.",
  ...
  "Automation with hooves: minimal fuss, maximal stomp.",
  ...
  "Hooves out, commit in—let's ship something mildly responsible.",
  "I'll butter your workflow like a mustang roll: messy, delicious, effective.",
  ...
  "Built by mustangs, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'openhoof gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.OPENHOOF_TAGLINE_INDEX;
