...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.OPENHOOF_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.OPENHOOF_DISABLE_LAZY_SUBCOMMANDS);
};

export const loadValidatedConfigForPluginRegistration =
  async (): Promise<OpenHoofConfig | null> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live OpenHoof docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  },
  {
    ...
    hasSubcommands: true,
    register: async (program) => {
      const mod = await import("../hoofbot-cli.js");
      mod.registerHoofbotCli(program);
    },
  },
  {
    name: "pairing",
