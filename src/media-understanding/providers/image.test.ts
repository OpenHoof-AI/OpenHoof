...
const ensureOpenHoofModelsJsonMock = vi.fn(async () => {});
...
describe("describeImageWithModel", () => {
  beforeEach(async () => {
    ...
    vi.doMock("../../agents/models-config.js", () => ({
      ensureOpenHoofModelsJson: ensureOpenHoofModelsJsonMock,
    }));
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureOpenHoofModelsJsonMock).toHaveBeenCalled();
