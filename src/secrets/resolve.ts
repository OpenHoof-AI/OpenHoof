...
function resolveResolutionLimits(config: OpenHoofConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OpenHoofConfig): SecretProviderConfig {
