...
export function listAuthProfileStorePaths(config: OpenHoofConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: OpenHoofConfig, stateDir: string): string[] {
