...
export function applyProviderDefaultModel(cfg: OpenHoofConfig, modelRef: string): OpenHoofConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: OpenHoofConfig; modelId: string; modelRef: string; profileId: string } {
