...
import type {
  ...
  OpenHoofPluginApi,
  OpenHoofPluginChannelRegistration,
  OpenHoofPluginCliRegistrar,
  OpenHoofPluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  OpenHoofPluginHttpRouteAuth,
  OpenHoofPluginHttpRouteMatch,
  OpenHoofPluginHttpRouteHandler,
  OpenHoofPluginHttpRouteParams,
  OpenHoofPluginHookOptions,
  MediaUnderstandingProviderPlugin,
  ProviderPlugin,
  OpenHoofPluginService,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: OpenHoofPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: OpenHoofPluginCliRegistrar;
  commands: string[];
  source: string;
  rootDir?: string;
};
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: OpenHoofPluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: OpenHoofPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: OpenHoofPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: OpenHoofPluginHookOptions | undefined,
    config: OpenHoofPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: OpenHoofPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: OpenHoofPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as OpenHoofPluginChannelRegistration).plugin === "object"
        ? (registration as OpenHoofPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: OpenHoofPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: OpenHoofPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: OpenHoofPluginCommandDefinition) => {
