...
export function applyGoogleGeminiModelDefault(cfg: OpenHoofConfig): {
  next: OpenHoofConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: OpenHoofConfig): OpenHoofConfig {
...
export function applyOpenAIConfig(cfg: OpenHoofConfig): OpenHoofConfig {
...
export function applyOpencodeGoModelDefault(cfg: OpenHoofConfig): {
  next: OpenHoofConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: OpenHoofConfig): {
  next: OpenHoofConfig;
  changed: boolean;
} {
