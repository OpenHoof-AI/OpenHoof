import { getActiveWebListener } from "openhoof/plugin-sdk/whatsapp";
import {
  getWebAuthAgeMs,
  logWebSelfId,
  logoutWeb,
...
let webLoginQrPromise: Promise<typeof import("openhoof/plugin-sdk/whatsapp-login-qr")> | null =
  null;
let webChannelPromise: Promise<typeof import("../../channels/web/index.js")> | null = null;
let whatsappActionsPromise: Promise<
  typeof import("openhoof/plugin-sdk/whatsapp-action-runtime")
> | null = null;

function loadWebLoginQr() {
  webLoginQrPromise ??= import("openhoof/plugin-sdk/whatsapp-login-qr");
...
function loadWhatsAppActions() {
  whatsappActionsPromise ??= import("openhoof/plugin-sdk/whatsapp-action-runtime");
