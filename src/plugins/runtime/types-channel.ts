 ...
 * OpenHoof messaging/runtime stack.
 */
...
export type PluginRuntimeChannel = {
  ...
  whatsapp: {
    getActiveWebListener: typeof import("openhoof/plugin-sdk/whatsapp").getActiveWebListener;
    getWebAuthAgeMs: typeof import("openhoof/plugin-sdk/whatsapp").getWebAuthAgeMs;
    logoutWeb: typeof import("openhoof/plugin-sdk/whatsapp").logoutWeb;
    logWebSelfId: typeof import("openhoof/plugin-sdk/whatsapp").logWebSelfId;
    readWebSelfId: typeof import("openhoof/plugin-sdk/whatsapp").readWebSelfId;
    webAuthExists: typeof import("openhoof/plugin-sdk/whatsapp").webAuthExists;
    sendMessageWhatsApp: typeof import("openhoof/plugin-sdk/whatsapp").sendMessageWhatsApp;
    sendPollWhatsApp: typeof import("openhoof/plugin-sdk/whatsapp").sendPollWhatsApp;
    loginWeb: typeof import("openhoof/plugin-sdk/whatsapp").loginWeb;
    startWebLoginWithQr: typeof import("openhoof/plugin-sdk/whatsapp-login-qr").startWebLoginWithQr;
    waitForWebLogin: typeof import("openhoof/plugin-sdk/whatsapp-login-qr").waitForWebLogin;
    monitorWebChannel: typeof import("../../channels/web/index.js").monitorWebChannel;
    handleWhatsAppAction: typeof import("openhoof/plugin-sdk/whatsapp-action-runtime").handleWhatsAppAction;
