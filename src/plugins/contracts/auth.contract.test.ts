...
import type { OpenHoofPluginApi, ProviderPlugin } from "../types.js";

type LoginOpenAICodexOAuth =
  (typeof import("openhoof/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("openhoof/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("openhoof/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("openhoof/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("openhoof/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openhoof/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("openhoof/plugin-sdk/agent-runtime", async (importOriginal) => {
...
function registerProviders(...plugins: Array<{ register(api: OpenHoofPluginApi): void }>) {
