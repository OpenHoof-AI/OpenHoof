...
export const PLUGIN_MANIFEST_FILENAME = "openhoof.plugin.json";
...
// package.json "openhoof" metadata (used for setup/catalog)
...
export type OpenHoofPackageStartup = {
  /**
...
export type OpenHoofPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: OpenHoofPackageStartup;
};
...
): OpenHoofPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
