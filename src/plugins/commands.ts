...
type RegisteredPluginCommand = OpenHoofPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
function listPluginInvocationKeys(command: OpenHoofPluginCommandDefinition): string[] {
...
function listPluginInvocationNames(command: OpenHoofPluginCommandDefinition): string[] {
