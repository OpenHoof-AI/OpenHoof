...
export function hasAmbiguousGatewayAuthModeConfig(cfg: OpenHoofConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: OpenHoofConfig): void {
