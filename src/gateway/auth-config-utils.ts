import type { GatewayAuthConfig, OpenHoofConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: OpenHoofConfig, password: string): OpenHoofConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
