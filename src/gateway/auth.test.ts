...
describe("gateway auth", () => {
  ...
  it("resolves token/password from OPENHOOF gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          OPENHOOF_GATEWAY_TOKEN: "env-token",
          OPENHOOF_GATEWAY_PASSWORD: "env-password",
  ...
  it("does not resolve legacy HOOFBOT gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          HOOFBOT_GATEWAY_TOKEN: "legacy-token",
          HOOFBOT_GATEWAY_PASSWORD: "legacy-password",
        } as NodeJS.ProcessEnv,
      }),
    ).toMatchObject({
      mode: "token",
  ...
  it("accepts password mode when env provides OPENHOOF_GATEWAY_PASSWORD", () => {
