...
import { type OpenHoofConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenHoofConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenHoofConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenHoofConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenHoofConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpenHoofConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: OpenHoofConfig): GatewaySessionsDefaults {
