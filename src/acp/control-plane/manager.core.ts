...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OpenHoofConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OpenHoofConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OpenHoofConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: OpenHoofConfig }): Promise<void> {
