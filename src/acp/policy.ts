...
export function isAcpEnabledByPolicy(cfg: OpenHoofConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: OpenHoofConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: OpenHoofConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: OpenHoofConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: OpenHoofConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: OpenHoofConfig, agentId: string): boolean {
