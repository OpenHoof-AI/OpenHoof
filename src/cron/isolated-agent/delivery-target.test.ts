...
function makeCfg(overrides?: Partial<OpenHoofConfig>): OpenHoofConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): OpenHoofConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: OpenHoofConfig) {
