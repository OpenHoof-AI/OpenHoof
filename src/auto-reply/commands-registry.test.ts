...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openhoof", { botUsername: "openhoof" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openhoof args", {
        botUsername: "openhoof",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@openhoof: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openhoof" })).toBe(
      "/help@otherbot",
    );
  });
