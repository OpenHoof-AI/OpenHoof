...
function resolveAcpStreamCoalesceIdleMs(cfg: OpenHoofConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OpenHoofConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OpenHoofConfig): AcpProjectionSettings {
