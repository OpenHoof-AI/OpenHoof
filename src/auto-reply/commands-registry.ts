...
export function isCommandEnabled(cfg: OpenHoofConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: OpenHoofConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: OpenHoofConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: OpenHoofConfig) {
