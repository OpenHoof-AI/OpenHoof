...
const shouldWarnCompatImport =
  ...
  process.env.OPENHOOF_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "openhoof/plugin-sdk/compat is deprecated for new plugins. Migrate to focused openhoof/plugin-sdk/<subpath> imports.",
    {
      code: "OPENHOOF_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
