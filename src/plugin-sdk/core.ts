...
export type { OpenHoofPluginApi } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin extends ChannelPlugin = ChannelPlugin> = {
  ...
  registerFull?: (api: OpenHoofPluginApi) => void;
};
...
type DefinePluginEntryOptions = {
  ...
  name: string;
  description: string;
  kind?: OpenHoofPluginDefinition["kind"];
  configSchema?: OpenHoofPluginConfigSchema | (() => OpenHoofPluginConfigSchema);
  register: (api: OpenHoofPluginApi) => void;
};
...
type DefinedPluginEntry = {
  ...
  register: NonNullable<OpenHoofPluginDefinition["register"]>;
} & Pick<OpenHoofPluginDefinition, "kind">;
