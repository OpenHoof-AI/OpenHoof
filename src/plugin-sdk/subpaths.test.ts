import * as channelRuntimeSdk from "openhoof/plugin-sdk/channel-runtime";
import * as channelSendResultSdk from "openhoof/plugin-sdk/channel-send-result";
import * as compatSdk from "openhoof/plugin-sdk/compat";
import * as coreSdk from "openhoof/plugin-sdk/core";
import type {
  ChannelMessageActionContext as CoreChannelMessageActionContext,
  OpenHoofPluginApi as CoreOpenHoofPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "openhoof/plugin-sdk/core";
import * as directoryRuntimeSdk from "openhoof/plugin-sdk/directory-runtime";
import * as discordSdk from "openhoof/plugin-sdk/discord";
import * as imessageSdk from "openhoof/plugin-sdk/imessage";
import * as lazyRuntimeSdk from "openhoof/plugin-sdk/lazy-runtime";
import * as lineSdk from "openhoof/plugin-sdk/line";
import * as lineCoreSdk from "openhoof/plugin-sdk/line-core";
import * as msteamsSdk from "openhoof/plugin-sdk/msteams";
import * as nostrSdk from "openhoof/plugin-sdk/nostr";
import * as ollamaSetupSdk from "openhoof/plugin-sdk/ollama-setup";
import * as providerModelsSdk from "openhoof/plugin-sdk/provider-models";
import * as providerSetupSdk from "openhoof/plugin-sdk/provider-setup";
import * as replyPayloadSdk from "openhoof/plugin-sdk/reply-payload";
import * as routingSdk from "openhoof/plugin-sdk/routing";
import * as runtimeSdk from "openhoof/plugin-sdk/runtime";
import * as sandboxSdk from "openhoof/plugin-sdk/sandbox";
import * as selfHostedProviderSetupSdk from "openhoof/plugin-sdk/self-hosted-provider-setup";
import * as setupSdk from "openhoof/plugin-sdk/setup";
import * as signalSdk from "openhoof/plugin-sdk/signal";
import * as slackSdk from "openhoof/plugin-sdk/slack";
import * as telegramSdk from "openhoof/plugin-sdk/telegram";
import * as testingSdk from "openhoof/plugin-sdk/testing";
import * as voiceCallSdk from "openhoof/plugin-sdk/voice-call";
import * as whatsappSdk from "openhoof/plugin-sdk/whatsapp";
import * as whatsappActionRuntimeSdk from "openhoof/plugin-sdk/whatsapp-action-runtime";
import * as whatsappLoginQrSdk from "openhoof/plugin-sdk/whatsapp-login-qr";
import { describe, expect, expectTypeOf, it } from "vitest";
import type { ChannelMessageActionContext } from "../channels/plugins/types.js";
import type { PluginRuntime } from "../plugins/runtime/types.js";
import type { OpenHoofPluginApi } from "../plugins/types.js";
import type {
  ChannelMessageActionContext as SharedChannelMessageActionContext,
  OpenHoofPluginApi as SharedOpenHoofPluginApi,
...
const bundledExtensionSubpathLoaders = pluginSdkSubpaths.map((id: string) => ({
  id,
  load: () => importPluginSdkSubpath(`openhoof/plugin-sdk/${id}`),
}));

const asExports = (mod: object) => mod as Record<string, unknown>;
const ircSdk = await import("openhoof/plugin-sdk/irc");
const feishuSdk = await import("openhoof/plugin-sdk/feishu");
const googlechatSdk = await import("openhoof/plugin-sdk/googlechat");
const zaloSdk = await import("openhoof/plugin-sdk/zalo");
const synologyChatSdk = await import("openhoof/plugin-sdk/synology-chat");
const zalouserSdk = await import("openhoof/plugin-sdk/zalouser");
const tlonSdk = await import("openhoof/plugin-sdk/tlon");
const acpxSdk = await import("openhoof/plugin-sdk/acpx");
const bluebubblesSdk = await import("openhoof/plugin-sdk/bluebubbles");
const matrixSdk = await import("openhoof/plugin-sdk/matrix");
const mattermostSdk = await import("openhoof/plugin-sdk/mattermost");
const nextcloudTalkSdk = await import("openhoof/plugin-sdk/nextcloud-talk");
const twitchSdk = await import("openhoof/plugin-sdk/twitch");
const accountHelpersSdk = await import("openhoof/plugin-sdk/account-helpers");
const allowlistEditSdk = await import("openhoof/plugin-sdk/allowlist-config-edit");
const mustangSdk = await import("openhoof/plugin-sdk/mustang");
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("exports shared core types used by bundled channels", () => {
    expectTypeOf<CoreOpenHoofPluginApi>().toMatchTypeOf<OpenHoofPluginApi>();
  ...
  it("keeps core shared types aligned with the channel prelude", () => {
    expectTypeOf<CoreOpenHoofPluginApi>().toMatchTypeOf<SharedOpenHoofPluginApi>();
  ...
  it("exports Mustang helpers", async () => {
    expect(typeof mustangSdk.definePluginEntry).toBe("function");
    expect(typeof mustangSdk.materializeWindowsSpawnProgram).toBe("function");
  });
