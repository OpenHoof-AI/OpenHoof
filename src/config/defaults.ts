...
function resolveAnthropicDefaultAuthMode(cfg: OpenHoofConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenHoofConfig): OpenHoofConfig {
...
export function applyTalkApiKey(config: OpenHoofConfig): OpenHoofConfig {
...
export function applyTalkConfigNormalization(config: OpenHoofConfig): OpenHoofConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: OpenHoofConfig): OpenHoofConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenHoofConfig): OpenHoofConfig {
...
export function applyLoggingDefaults(cfg: OpenHoofConfig): OpenHoofConfig {
...
export function applyContextPruningDefaults(cfg: OpenHoofConfig): OpenHoofConfig {
...
export function applyCompactionDefaults(cfg: OpenHoofConfig): OpenHoofConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
